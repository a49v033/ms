...
public class GetNewToken {
	...
	public ModelAndView grap(@RequestParam(name = "refresh_token", required = true) String refresh_token) {
		...
		String json = "client_id="+appId+"&redirect_uri="+uri+"&client_secret="+appPwd+"&scope=Files.ReadWrite.All%20offline_access&grant_type=refresh_token&refresh_token="+refresh_token;
